    ...
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <Reveal>
            <div className="text-center mb-14">
              <h2 className="text-3xl font-bold text-brand-ink mb-3">What Hostera AI does</h2>
              <p className="text-brand-slate max-w-2xl mx-auto">Six capabilities designed for hotel managers — not gimmicks.</p>
            </div>
          </Reveal>
            ...
            {capabilities.map((c, i) => {
              ...
              return (
                <Reveal key={c.title} delay={(i % 3) * 0.08}>
                  <div className="p-6 rounded-2xl border border-brand-border hover:shadow-xl hover:border-brand-blue/30 transition-all h-full">
                    <div className="w-11 h-11 rounded-full bg-brand-bg flex items-center justify-center mb-4">
                      <Icon className="w-5 h-5 text-brand-navy" />
                    </div>
                    <h3 className="text-base font-semibold text-brand-ink mb-2">{c.title}</h3>
                    <p className="text-[13px] text-brand-slate leading-relaxed">{c.desc}</p>
                  </div>
                </Reveal>
              );
            })}
      ...
      <section className="py-20 bg-brand-bg">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <Reveal>
            <h2 className="text-2xl font-bold text-brand-ink mb-3">Hostera AI is rolling out progressively</h2>
